...
// create function to recall menu 
function Menu() {
    return (
        <> 
        <nav className="navbar navbar-dark bg-dark fixed-top">
            <div className="container-fluid">
                <a className="navbar-brand" href="#" id="healmeat">Discover the best vegetarian recipes</a>
                ...
                <div className="offcanvas offcanvas-end text-bg-dark" id="offcanvasDarkNavbar"
                    ...
                    <div className="offcanvas-header">
                        <h5 className="offcanvas-title" id="NavbarLabel">Navigate</h5>
