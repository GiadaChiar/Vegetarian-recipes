...
export const Standardcarts = [
  ...
  {
    foodImage: "https://img.spoonacular.com/recipes/658914-312x231.jpg",
    nameText: "Muffin",
    timeText: "10",
    healthy: "60",
    code: "658914",
...
export default function FakeCarts() {

    return <>{Standardcarts.map((cart, index) => {
        return (
            <RealCart
                    key={index}
                    code={cart.code}
                    extraClass={`number${index + 1}`}
